...
async function fetchCompany(companyId?: string | null): Promise<PdfCompany | null> {
  if (companyId) {
...
async function fetchDefaultBank(companyId?: string | null): Promise<PdfBankAccount | null> {
